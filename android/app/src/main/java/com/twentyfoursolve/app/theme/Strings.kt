...
private val englishStrings = mapOf(
    ...
    "easy" to "Easy",
    "easyDesc" to "Simple numbers (1–10), basic operations.",
    "medium" to "Medium",
    "mediumDesc" to "Mixed operations, numbers up to 20.",
    "hard" to "Hard",
    "hardDesc" to "Fractions, large numbers, complex solves.",
...
private val chineseStrings = mapOf(
    ...
    "easy" to "简单",
    "easyDesc" to "基础数字 (1-10)，基础运算。",
    "medium" to "中等",
    "mediumDesc" to "混合运算，数字最高到 20。",
    "hard" to "困难",
    "hardDesc" to "涉及分数、大数字和复杂解法。",
    "targetSet" to "目标数值",
