...
private val englishStrings = mapOf(
    ...
    "daily" to "Daily Puzzle",
    "dailyIncomplete" to "Not done today",
    "dailyDone" to "Streak %1\$d · Best %2\$d",
    "done" to "Done",
    "dailyStreak" to "Daily streak",
    "dailyToday" to "Today's best",
    ...
    "yourAttempt" to "You reached",
    "unsolvableWin" to "You spotted that this hand has no solution.",
    "scorePoints" to "%d pts",
...
private val chineseStrings = mapOf(
    ...
    "startGame" to "开始游戏",
    "daily" to "每日一题",
    "dailyIncomplete" to "今日未完成",
    "dailyDone" to "连续 %1\$d 天 · 最高 %2\$d 分",
    "done" to "完成",
    "dailyStreak" to "每日连续",
    "dailyToday" to "今日最高",
